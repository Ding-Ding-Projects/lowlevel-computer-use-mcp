...
The optional HTTP mode exposes the standard Model Context Protocol Streamable HTTP
endpoint at `http://127.0.0.1:8765/mcp`. It is not a REST API: clients initialize a
